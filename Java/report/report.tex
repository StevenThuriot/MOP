...
Class diagrams of different subsystems are included in the appendix in the end of this file. These include a class diagram of the controller subsystem and a class diagram of all model classes.
	...
	\section{New requirements and related changes}
		...
		%Kleine algemene inleiding
			\subsubsection{General implementation}
			%Algemeen: Resource, User, Task Types
			\subsubsection{TaskType dependent requirements}
			%Constraints per TaskType --> TaskTypeConstraint 
	...
	\section{Other changes}
		...
		\subsection{Software Initialization}
			The initialization changed quite a bit since the last report. This is mainly caused by the new requirements. The biggest changes are in the parsing of the XML files.
