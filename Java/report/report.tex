	...
	\section{Software Structures}
		\subsection{Task states}
			...
			\subsubsection{Observer Pattern}
				\emph{When the state of a task changes this may invalidate Business Rule 2, so when a state is changed other taks may have to change state as well. For this we use the observer pattern to inform dependent tasks of the state change whom will change their state accordingly.}
