...
\section{Introduction}
		...
		In the following chapters, the reader will get a general overview of the outer- and inner workings of the application, accompanied by several diagrams. The report is made up in two parts. The first part contains all the design dicisions we made in the first and second iteration of the project. In part 2 we will discuss how we handled the new requirements and how we changed our application to meet those requirements.
...
Class diagrams of different subsystems are included in the appendix in the end of this file. These include a class diagram of the controller subsystem and a class diagram of all model classes.
	...
	\section{Software Structures}
		...
		The class FocusFactory takes care of Strategy constructors and injecting. The GUI now simply calls a method in this class, a pre-fabricated FocusWork is returned. A class diagram of the FocusWork subsystem is included in the appendix.\\
