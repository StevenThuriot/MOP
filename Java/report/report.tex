...
\section{Introduction}
	...
	\section{Project Management - Iteration 1}
		...
		\end{tabular}
		\textbf{Iteration 2:}
		We had a total of 18 hours meeting physically for the iteration. Besides that, every group member worked at home: A short estimate follows:
		\begin{tabular}{l|l}
		Member & Time(+/-)\\ \hline
		Kwinten Missiaen & 30\\
		Steven Thuriot & 25\\
	...
	\begin{figure}[H]
		\begin{center}
			\includegraphics[scale=0.6]{images/ControllerClassDiagram.jpg}
		\end{center}
